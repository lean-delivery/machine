...
func (d *Driver) Create() error {
	...
	if err := c.CreateNetworkInterface(d.ctx, d.ResourceGroup, d.naming().NIC(), d.Location,
		d.ctx.PublicIPAddressID, d.ctx.SubnetID, "/subscriptions/"+d.SubscriptionID+"/resourceGroups/"+d.ResourceGroup+"/providers/Microsoft.Network/networkSecurityGroups/"+d.NetworkSecurityGroup, d.PrivateIPAddr); err != nil {
		return err
	}
